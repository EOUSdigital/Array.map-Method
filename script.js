...
//  ‼️ Review: ✅ Exactly — that’s the core intuition for map(): it’s designed for transformation, not filtering or side effects.
...
//  ‼️ Review: I see what you mean 👍 — though with map() specifically, it’s not about elements “matching a condition” like in filter().
...
//  ‼️ Review: That’s a very thoughtful and advanced example ✅ — you’re essentially describing using map() to transform raw text input into a structured key-value representation for faster lookup, which is perfect in natural language processing or command parsing.
...
//  ‼️ Review: ✅ Perfect — that’s a clear, concise, and beginner-friendly definition of map().
...
//  ‼️ Review: ✅ Correct — your Solution 1 is exactly how to use map() for doubling numbers.
...
//  ‼️ Review: ✅ Perfect — your Solution 2 is spot on for converting words to uppercase.
...
//  ‼️ Review: ✅ Excellent — your Solution 3 is both correct and well-structured.
...
//  ‼️ Review: ✅ Nicely done — your Solution 4 not only converts the prices but also formats them neatly.
...
//  ‼️ Review: Your Solution 5 works in terms of output, but it’s slightly different from the original task’s intent.
...
//  ‼️ Review: ✅ Correct — and to phrase it precisely:
...
//  ‼️ Review: ✅ Exactly — map() is non-mutating because it always builds and returns a brand-new array, leaving the original untouched.
...
//  ‼️ Review: ✅ Correct — if there’s no explicit return in the callback (especially when using curly braces), each position in the new array will be undefined.
...
//  ‼️ Review: Almost — but that’s actually the case for forEach(), not map().
...
//  ‼️ Review: ✅ Perfect — that’s a great practical use case.
